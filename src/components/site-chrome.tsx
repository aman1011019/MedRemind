      ...
      <div className="mx-auto max-w-7xl px-4">
        <div className={`flex items-center justify-between rounded-full px-4 sm:px-6 py-3 transition-all ${scrolled ? "glass-strong" : "glass"}`}>
          ...
          <div className="hidden md:flex items-center gap-2">
            <a href="https://raw.githubusercontent.com/aman1011019/MedRemind/apk/MEDREMIND-AI.apk" download="MEDREMIND-AI.apk" className="btn-liquid !py-2 !px-4 !text-sm flex items-center justify-center">Download APK</a>
          </div>
        ...
        {open && (
          <div className="md:hidden mt-2 glass-strong rounded-3xl p-4 animate-in fade-in slide-in-from-top-4 duration-300">
            <div className="flex flex-col gap-1">
              ...
              <a href="https://raw.githubusercontent.com/aman1011019/MedRemind/apk/MEDREMIND-AI.apk" download="MEDREMIND-AI.apk" onClick={() => setOpen(false)} className="btn-liquid mt-2 flex items-center justify-center">Download APK</a>
            </div>
          </div>
        )}
      </div>
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 py-20">
        <div className="grid gap-14 md:grid-cols-4">
          ...
          <div className="md:col-span-2">
            ...
            <div className="mt-6">
              <a
                href="https://raw.githubusercontent.com/aman1011019/MedRemind/apk/MEDREMIND-AI.apk"
