    ...
    <section ref={ref} className="relative min-h-screen flex items-center pt-32 pb-20">
      ...
      <div className="mx-auto max-w-7xl px-4 grid lg:grid-cols-2 gap-12 items-center relative">
        <motion.div style={{ y, opacity }}>
          ...
          >
            <a href="https://github.com/aman1011019/Medremind/releases/latest/download/MEDREMIND-AI.apk" download="MEDREMIND-AI.apk" className="btn-liquid flex items-center justify-center gap-2">
    ...
    <section id="download" className="relative py-32">
      ...
      <div className="mx-auto max-w-5xl px-4 text-center">
        ...
        <div className="mt-10 flex flex-wrap justify-center gap-3">
          <a href="https://github.com/aman1011019/Medremind/releases/latest/download/MEDREMIND-AI.apk" download="MEDREMIND-AI.apk" className="btn-liquid flex items-center justify-center gap-2"><Download className="h-4 w-4" /> Download Android APK</a>
