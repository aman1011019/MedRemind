    ...
    <section ref={ref} className="relative min-h-screen flex items-center pt-32 pb-20">
      ...
      <div className="mx-auto max-w-7xl px-4 grid lg:grid-cols-2 gap-12 items-center relative">
        <motion.div style={{ y, opacity }}>
          ...
          >
            <a href="https://github.com/aman1011019/MedRemind-AI/raw/refs/heads/apk/MEDREMIND-AI-1.0.2.apk" download="MEDREMIND-AI-1.0.2.apk" className="btn-liquid flex items-center justify-center gap-2">
  ...
  return (
    <section id="download" className="relative py-32">
      ...
      <div className="mx-auto max-w-5xl px-4 text-center">
        ...
        <p className="mt-6 text-muted-foreground text-lg">Version 1.0.2 · 59 MB · Android 10+ supported</p>
        <div className="mt-10 flex flex-wrap justify-center gap-3">
          <a href="https://github.com/aman1011019/MedRemind-AI/raw/refs/heads/apk/MEDREMIND-AI-1.0.2.apk" download="MEDREMIND-AI-1.0.2.apk" className="btn-liquid flex items-center justify-center gap-2"><Download className="h-4 w-4" /> Download Android APK</a>
